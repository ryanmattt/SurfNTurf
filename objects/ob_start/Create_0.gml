...
_draw_credits_left = function(_element, _index) {
   draw_text(room_width*1/8, global._wHeight*1/6+string_height(" ")*_index*1.5, string(_element));
}
_draw_credits_right = function(_element, _index) {
   draw_text(room_width*7/8, global._wHeight*1/6+string_height(" ")*_index*1.5, string(_element));
}